export const notifications = {
  beforePostDeletion: "Your 'name' post created at 'date' will be deleted tomorrow at 9PM.",
  afterPostDeletion: "Your 'name' post created at 'date' has been deleted.",
  afterDelay: "Your post deletion has been delayed until 'date'",
